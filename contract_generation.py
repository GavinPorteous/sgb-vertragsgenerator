...
if __name__ == "__main__":
    ...
    # Note: This line is typically only run when this script is executed directly,
    # not when it's imported as a module. Remove or comment out for Flask app usage.
